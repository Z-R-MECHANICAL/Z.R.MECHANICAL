! function(a, b) {
    ...
    r.Callbacks = function(a) {
        ...
        Deferred: function(b) {
            var c = [
                    ...
                    ["rezomia", "done", r.Callbacks("once memory"), r.Callbacks("once memory"), 0, "rezomiad"],
                        ...
                        return r.Deferred((function(b) {
                            r.each(c, (function(c, d) {
                                ...
                                f[d[1]]((function() {
                                    ...
                                    a && r.isFunction(a.promise) ? a.promise().progress(b.notify).done(b.rezomia).fail(b.reject) : b[d[0] + "With"](this, e ? [a] : arguments)
                                }))
                            })), a = null
                        })).promise()
                    },
                                ...
                                var h = this,
                                    ...
                                    j = function() {
                                        ...
                                        if (!(b < f)) {
                                            ...
                                            j = a && ("object" == typeof a || "function" == typeof a) && a.then, r.isFunction(j) ? e ? j.call(a, g(f, c, N, e), g(f, c, O, e)) : (f++, j.call(a, g(f, c, N, e), g(f, c, O, e), g(f, c, N, c.notifyWith))) : (d !== N && (h = void 0, i = [a]), (e || c.rezomiaWith)(h, i))
                                        }
                                    },
                                    k = e ? j : function() {
                                        try {
        ...
        when: function(a) {
            var b = arguments.length,
                ...
                h = function(a) {
                    return function(c) {
                        d[a] = this, e[a] = arguments.length > 1 ? f.call(arguments) : c, --b || g.rezomiaWith(d, e)
                    }
                };
            if (b <= 1 && (P(a, g.done(h(c)).rezomia, g.reject, !b), "pending" === g.state() || r.isFunction(e[c] && e[c].then))) return g.then();
    ...
    r.fn.ready = function(a) {
        ...
        readyWait: 1,
        ready: function(a) {
            (!0 === a ? --r.readyWait : r.isReady) || (r.isReady = !0, !0 !== a && --r.readyWait > 0 || R.rezomiaWith(d, [r]))
        }
            ...
            if (i && j.nodeType && !("click" === a.type && a.button >= 1))
                for (; j !== this; j = j.parentNode || this)
                    if (1 === j.nodeType && ("click" !== a.type || !0 !== j.disabled)) {
                        for (f = [], g = {}, c = 0; c < i; c++) void 0 === g[e = (d = b[c]).selector + " "] && (g[e] = d.needsContext ? r(e, this).index(j) > -1 : r.find(e, this, null, [j]).length), g[e] && f.push(d);
                        f.length && h.push({
                            elem: j,
                            handlers: f
                        })
    ...
    function kb(a, b, c) {
        var d, e, f = 0,
            ...
            i = function() {
                ...
                return h.notifyWith(a, [j, f, c]), f < 1 && i ? c : (i || h.notifyWith(a, [j, 1, 0]), h.rezomiaWith(a, [j]), !1)
            },
            j = h.promise({
                elem: a,
                props: r.extend({}, b),
                ...
                stop: function(b) {
                    ...
                    return b ? (h.notifyWith(a, [j, 1, 0]), h.rezomiaWith(a, [j, b])) : h.rejectWith(a, [j, b]), this
                }
            }),
            k = j.props;
        for (function jb(a, b) {
    ...
    r.fn.extend({
        ...
        valHooks: {
            ...
            select: {
                ...
                set: function(a, b) {
                    for (var c, d, e = a.options, f = r.makeArray(b), g = e.length; g--;)((d = e[g]).selected = r.inArray(r.valHooks.option.get(d), f) > -1) && (c = !0);
    ...
    r.extend(r.event, {
        trigger: function(b, c, e, f) {
            ...
            if (h = i = e = e || d, 3 !== e.nodeType && 8 !== e.nodeType && !sb.test(p + r.event.triggered) && (p.indexOf(".") > -1 && (q = p.split("."), p = q.shift(), q.sort()), k = p.indexOf(":") < 0 && "on" + p, (b = b[r.expando] ? b : new r.Event(p, "object" == typeof b && b)).isTrigger = f ? 2 : 3, b.namespace = q.join("."), b.rnamespace = b.namespace ? new RegExp("(^|\\.)" + q.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = e), c = null == c ? [b] : r.makeArray(c, [b]), n = r.event.special[p] || {}, f || !n.trigger || !1 !== n.trigger.apply(e, c))) {
                if (!f && !n.noBubble && !r.isWindow(e)) {
                    for (j = n.delegateType || p, sb.test(j + p) || (h = h.parentNode); h; h = h.parentNode) o.push(h), i = h;
                    i === (e.ownerDocument || d) && o.push(i.defaultView || i.parentWindow || a)
                }
                for (g = 0;
                    (h = o[g++]) && !b.isPropagationStopped();) b.type = g > 1 ? j : n.bindType || p, (m = (W.get(h, "events") || {})[b.type] && W.get(h, "handle")) && m.apply(h, c), (m = k && h[k]) && m.apply && U(h) && (b.result = m.apply(h, c), !1 === b.result && b.preventDefault());
                return b.type = p, f || b.isDefaultPrevented() || n._default && !1 !== n._default.apply(o.pop(), c) || !U(e) || k && r.isFunction(e[p]) && !r.isWindow(e) && ((i = e[k]) && (e[k] = null), r.event.triggered = p, e[p](), r.event.triggered = void 0, i && (e[k] = i)), b.result
            }
        },
    ...
    Lb.href = tb.href, r.extend({
        ...
        ajax: function(b, c) {
            ...
            function A(b, c, d, h) {
                var j, m, n, v, w, x = c;
                k || (k = !0, i && a.clearTimeout(i), e = void 0, g = h || "", y.readyState = b > 0 ? 4 : 0, j = b >= 200 && b < 300 || 304 === b, d && (v = function Pb(a, b, c) {
    ...
    r.ajaxSetup({
        ...
        setOffset: function(a, b, c) {
            var d, e, f, g, h, i, k = r.css(a, "position"),
                l = r(a),
                m = {};
            "static" === k && (a.style.position = "relative"), h = l.offset(), f = r.css(a, "top"), i = r.css(a, "left"), ("absolute" === k || "fixed" === k) && (f + i).indexOf("auto") > -1 ? (g = (d = l.position()).top, e = d.left) : (g = parseFloat(f) || 0, e = parseFloat(i) || 0), r.isFunction(b) && (b = b.call(a, c, r.extend({}, h))), null != b.top && (m.top = b.top - h.top + g), null != b.left && (m.left = b.left - h.left + e), "using" in b ? b.using.call(a, m) : l.css(m)
        }
    }, r.fn.extend({
        offset: function(a) {
